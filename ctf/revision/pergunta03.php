...
<?php
	...
	$sql = "SELECT * FROM perguntas WHERE modulo = 'REV3'";
...
?>
	<div id="questionweb1">
		<form method="POST">
			<fieldset>
				<legend>TERCEIRA PERGUNTA - REVISION</legend>
				<div>
					<label><?=$rows['pergunta'];?></label>
					<input id="respostarevision3" name="respostarevision3" class="text">
					<input type="submit" id="submitrevision3" name="submitrevision3" value="Responder" class="submit">
				</div>
			</fieldset>
		</form>
	</div>
