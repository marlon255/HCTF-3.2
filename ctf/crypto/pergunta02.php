...
?>
	<div id="questionweb1">
		<form method="POST">
			<fieldset>
				<legend>SEGUNDA PERGUNTA - CRYPTOGRAPHY</legend>
					<label><?=$rows['pergunta'];?></label>
					<div>
					<input id="respostacrypto2" name="respostacrypto2" class="text">
					<input type="submit" id="submitcrypto2" name="submitcrypto2" value="Responder" class="submit">
				</div>
			</fieldset>
		</form>
	</div>
