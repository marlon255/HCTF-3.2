...
<body>
	<div id="questionweb1">
		<form method="POST">
			<fieldset>
				<legend>SEGUNDA PERGUNTA - WEB</legend>
					<label><?=$rows['pergunta'];?></label>
					<input id="respostaweb2" name="respostaweb2" class="text">
					<input type="submit" id="submitweb2" name="submitweb2" value="Responder" class="submit">
			</fieldset>
		</form>
	</div>
</body>
